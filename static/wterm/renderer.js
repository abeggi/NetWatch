...
export class Renderer {
  ...
  _buildScrollbackRowEl(bridge, sbOffset) {
    ...
    this._buildRowContent(rowEl, (col) => bridge.getScrollbackCell(sbOffset, col), lineLen, -1);
    return rowEl;
  }
  ...
  render(bridge) {
    ...
    for (let r = 0; r < this.rows; r++) {
      ...
      if (isDirty || hadCursor || (hasCursor && needsCursorUpdate)) {
        ...
        this._buildRowContent(this.rowEls[r], (col) => bridge.getCell(r, col), this.cols, cCol);
      }
    }
